...
class ProductPage(BasePage):
    ...
    def should_be_book_name_the_same(self):
        ...
        assert book_name in book_name_in_basket, "book name in message is different from added book name"
    ...
    def should_be_book_price_the_same(self):
        ...
        assert book_price in book_price_in_basket, "book price in message is different from the price of added book "
